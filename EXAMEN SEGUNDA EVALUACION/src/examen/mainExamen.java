package examen;
/**
 * AARON ESTUDIA MÉS SINO NO APROVARAS TOT!!!!!!!!!!!!!!!!!!!!!
 */
...
public class mainExamen {
	...
	public static void estadisticas(){
		...
		System.out.println("El paquete con m�s anchura, tiene: "+anchoMaximo);
		System.out.println("El paquete con m�s anchura es: "+toString01);
	}
